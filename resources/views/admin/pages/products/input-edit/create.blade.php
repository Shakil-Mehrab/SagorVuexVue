            ...
            {{csrf_field()}}
              ...
              <div class="row">
                  ...
                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-12">
                      ...
                      <input type="text" name="name" id="name" class="form-control" placeholder="Product Name" value="{{Request::old('name')}}">
                       @if ($errors->has('name'))
                  ...
                  @endif
                   ...
                   <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-12">
                      ...
                      <input type="text" name="price" id="price" class="form-control" placeholder="Price (US-$" value="{{Request::old('price')}}">
                       @if ($errors->has('price'))
                      <span class="help-block">
              ...
              <div class="row">
                @include('admin.pages.products.input-edit.partials.form.input-select')
              </div>
                <div class="col-lg-12 col-md-12 col-sm-12" style="background: black;color:white">
              ...
              <div class="row">
                  ...
                  <div class="form-group col-lg-12">
                      <textarea name="detail" class="form-control my-editor" placeholder="Detailed Information" class="my-editor">{{Request::old('detail')}}</textarea>
